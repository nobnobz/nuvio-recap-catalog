...
## Context-aware recovery — September 7, policy 6

All 370 remaining candidates were rechecked. Runs [34105485252](https://github.com/nobnobz/nuvio-recap-catalog/actions/runs/34105485252) and [34105662005](https://github.com/nobnobz/nuvio-recap-catalog/actions/runs/34105662005) succeeded, including Cloudflare publication verification. Public r28 now contains **242 videos / 116 series**, five more videos than r26: Ozark seasons 1–3, Andor season 2, Wednesday season 1, Squid Game season 2, and The Walking Dead seasons 1–11. The Ozark description range is independently corroborated by all three season chapter headings and episode metadata. The Walking Dead actor credit no longer causes a fan-theory false positive.

There are zero pending identities and zero identity errors. The 365 remaining candidates have primary reasons: 239 unsupported/non-explicit titles, 60 unresolved identities, 17 context/suffix conflicts, 16 mixed-format flags, 12 availability restrictions, 10 missing audio-language declarations, 10 duration exclusions, and one unverified season range. More candidates now reach identity validation, so that category can grow while the total rejected count shrinks. The Boys publisher suffix is supported, but two exact same-name series (2019 and 1993) still prevent automatic admission; no identity was guessed.

All 42 hosting tests passed, including harmless versus risky hashtags, actor credits versus actual theories, publisher suffixes versus mixed-series suffixes, description ranges with missing or conflicting chapters, contradictory future-season hints, and end-to-end resolution plus episode-number verification. Published r28 was independently matched against the committed catalog.

Normal-default follow-up [34105867627](https://github.com/nobnobz/nuvio-recap-catalog/actions/runs/34105867627) also succeeded: zero candidates and identity resolutions, 60 health checks, 10 YouTube requests, unchanged r28, no pending work.
